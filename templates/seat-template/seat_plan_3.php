<?php 
function wbtm_seat_plan_3($start,$date){
	$seat_style = 2;
                ...
                <?php foreach ( $seat_row_arr as $seat_row ) { ?>
                    <tr class="seat<?php echo get_the_id(); ?>_lists ">
                        <?php foreach ( $seat_col_arr as $seat_col ) {
                            ...
                            $get_seat_status    = wbtm_get_seat_status($seat_name,$date,get_the_id(),$start);
                            if ($get_seat_status) {
                        ...
                        <td>
                            ...
                            <?php } else { ?> <a data-seat='<?php echo $seat_row.$seat_col; ?>' id='seat<?php echo get_the_id(); ?>_<?php echo $seat_row.$seat_col; ?>' data-sclass='Economic' class='seat<?php echo get_the_id(); ?>_blank blank_seat'><?php echo $seat_row.$seat_col; ?></a>
                            <?php } ?>
                        </td>                        
