<?php 
function wbtm_seat_plan_1($start,$date){
	$seat_style 		= 2;
                    ...
                    <tr class="seat<?php echo get_the_id(); ?>_lists ">
                        ...
                        <td>
                            ...
                            <?php } else { ?> 
                                ...
                                <a data-seat='<?php echo $seat_row.$seat_col; ?>' id='seat<?php echo get_the_id(); ?>_<?php echo $seat_row.$seat_col; ?>' data-sclass='Economic' class='seat<?php echo get_the_id(); ?>_blank blank_seat'><?php echo $seat_row.$seat_col; ?></a>
                            <?php } ?>
                        </td>                        
